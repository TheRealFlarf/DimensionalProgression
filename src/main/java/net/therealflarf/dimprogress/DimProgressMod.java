 ...
 *
 */
package net.therealflarf.dimprogress;
...
@Mod("dim_progress")
public class DimProgressMod {
	public static final Logger LOGGER = LogManager.getLogger(DimProgressMod.class);
	public static final String MODID = "dim_progress";
