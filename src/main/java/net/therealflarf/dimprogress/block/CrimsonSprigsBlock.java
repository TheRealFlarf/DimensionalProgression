...
public class CrimsonSprigsBlock extends FlowerBlock {
	...
	public boolean mayPlaceOn(BlockState groundState, BlockGetter worldIn, BlockPos pos) {
		return groundState.is(DimProgressModBlocks.CRIMSOIL.get()) || groundState.is(DimProgressModBlocks.CRIMSON_CRIMSOIL_GRASS.get()) || groundState.is(DimProgressModBlocks.CRIMSON_MUD.get());
	}
