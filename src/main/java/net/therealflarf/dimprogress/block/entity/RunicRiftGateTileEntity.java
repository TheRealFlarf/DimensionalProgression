...
public class RunicRiftGateTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public RunicRiftGateTileEntity(BlockPos pos, BlockState state) {
		super(DimProgressModBlockEntities.RUNIC_RIFT_GATE.get(), pos, state);
	}
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<RunicRiftGateTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<RunicRiftGateTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("runic_rift_gate");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Runic Rift Gate");
	}
