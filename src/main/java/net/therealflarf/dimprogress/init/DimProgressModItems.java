...
public class DimProgressModItems {
	...
	public static final RegistryObject<Item> DEAD_CRIMSON_SPRIGS = block(DimProgressModBlocks.DEAD_CRIMSON_SPRIGS);
	public static final RegistryObject<Item> DEAD_CRIMSOIL_GRASS = block(DimProgressModBlocks.DEAD_CRIMSOIL_GRASS);
	public static final RegistryObject<Item> DARK_CRIMSON_SPRIGS = block(DimProgressModBlocks.DARK_CRIMSON_SPRIGS);
	public static final RegistryObject<Item> DARK_CRIMSON_CRIMSOIL_GRASS = block(DimProgressModBlocks.DARK_CRIMSON_CRIMSOIL_GRASS);
